...
import { X, Eye, Import } from "lucide-react"
import { cancelAppointment } from "../../_action/cancel-appointment"
...
export function AppointmentsList({ times }:AppointmentsListProps){
    ...
    return(
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>        
            <Card>
                <CardHeader className="flex flex-row items-center justify-between spacy-y-0 pb-2">
                ...
                <CardContent>
                    <ScrollArea className="h-[calc(100vh-20rem)] lg:h-[cal(100vh-15rem)] pr-4">
                        {isLoading ? (
